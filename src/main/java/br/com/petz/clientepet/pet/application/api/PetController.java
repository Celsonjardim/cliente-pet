...
public class PetController implements PetAPI {
	...
	public void deletePetDoClienteComId(UUID idCliente, UUID idPet) {
		...
		log.info("[idCliente] {} - [idPet] {}", idCliente, idPet);
		petService.deletaPetsDoClienteComID(idCliente, idPet);
		log.info("[finaliza] PetController - deletePetDoClienteComId");
	}

	@Override
	public PetAlteracaoRequest patchPet(UUID idCliente, UUID idPet, 
			@Valid PetAlteracaoRequest petAlteracaoRequest) {
